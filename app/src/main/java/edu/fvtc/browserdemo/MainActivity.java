...
import edu.fvtc.browserdemo.databinding.ActivityMainBinding;
    ...
    private NavigationBarView.OnItemSelectedListener onItemSelectedListener = new NavigationBarView.OnItemSelectedListener() {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            if(id == R.id.navigation_dashboard)
            {
                ...
                webView.loadUrl("https://foote.azurewebsites.net/Home/SpringSchedule");
            }
